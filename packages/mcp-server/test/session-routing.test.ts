...
import { buildSessionId, currentMachineId, routeUnknownSession } from '../src/session-routing';

describe('currentMachineId', () => {
  it('reads a well-formed FLY_MACHINE_ID', () => {
    expect(currentMachineId({ FLY_MACHINE_ID: '17811953c25489' })).toBe('17811953c25489');
  });
